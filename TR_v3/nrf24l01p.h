...
#define CSN0		PORTB &= ~(1<<4)
#define CSN1		PORTB |= (1<<4)
#define DDCSN		DDRB |= (1<<4)
#define CE0			PORTD &= ~(1<<3)
#define CE1			PORTD |= (1<<3)
#define DDCE		DDRD |= (1<<3)
#define IRQ1		PORTD |= (1<<2)
#define CLK0		PORTB &= ~(1<<7)
#define DDCLK		DDRB |= (1<<7)
#define DDMOSI		DDRB |= (1<<5)
#define DDMISO		DDRB |= (1<<6)
